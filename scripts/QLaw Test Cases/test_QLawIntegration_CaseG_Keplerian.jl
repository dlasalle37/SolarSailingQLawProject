...
nue = coee[6]
X0 = [9222.7; 0.2; 0.573*pi/180; 0.0; 0.0; 0.0]  # COE initial conditions [a, e, i, argPer, lambda, trueAnom]
XT = [26700, 0.7, 10.0*pi/180, 30*pi/180, 30*pi/180] # Targets # note that targets has 5 elements, while X0 has 6
