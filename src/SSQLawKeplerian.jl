...
"""
function compute_control_kep(x, params::QLawParams)
    # Unpacking:
...
"""
function calculate_Q_kep(x, params)
        ...
        adotnn = oedotnn_kep(a, e, inc, ape, lam, nustar_a, sig_a, eps_a, nudot, params, t)
        ...
        edotnn1 = oedotnn_kep(a, e, inc, ape, lam,nustar_e1, sig_e, eps_e, nudot, params, t)
        edotnn2 = oedotnn_kep(a, e, inc, ape, lam,nustar_e2, sig_e, eps_e,nudot, params, t)
        ...
        incdotnn = oedotnn_kep(a, e, inc, ape, lam, nustar_inc, sig_inc, eps_inc, nudot, params, t)
        ...
        if Wape == 0.0
            ...
            apedotnn = oedotnn_kep(a, e, inc, ape, lam, nustar_ape, sig_ape, eps_ape, nudot, params, t)
        ...
        if Wran == 0.0
            ...
            randotnn = oedotnn_kep(a, e, inc, ape, lam, nustar_ran, sig_ran, eps_ran, nudot, params, t)
...
"""
    oedotnn_kep(a, e, inc, ape, lam, tru, nustar_oe, sig_oe, eps_oe, tru_E, nudot, nudot_body, params::QLawParams, t)
...
"""
function oedotnn_kep(a, e, inc, ape, lam, nustar_oe, sig_oe, eps_oe, nudot, params::QLawParams, t)
    sc = params.sc
    mu = params.mu
    eph = params.eph
    R_H_O_star = hill_to_orbit_transform(inc, ape, lam, nustar_oe)
    Foe = Fkep(a, e, inc, ape, nustar_oe, mu)
