...
const EARTH_SOLAR_FLUX = 1.02E14 
# Approximate constants for Earth's heliocentric orbit
const SUN_MU = 1.327E11  #km^3/s^2
const EARTH_HELIOC_ECC = 0.0167
const EARTH_HELIOC_SEMIMAJOR = 149598023.0  # km
const SUN_EARTH_DIST_NOMINAL = 149597870.691 # km
